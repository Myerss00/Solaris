...
INTERNAL_TOOL_TOKEN = os.environ.get("SOLARIS_INTERNAL_TOKEN") or secrets.token_hex(32)
INTERNAL_TOOL_HEADER = "X-Solaris-Internal-Token"
...
def require_admin(request: Request):
    ...
    # (a) header-direct (caller set X-Solaris-Internal-Token), or
