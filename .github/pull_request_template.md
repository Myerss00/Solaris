...
- [ ] I searched [open issues](https://github.com/pewdiepie-archdaemon/solaris/issues) and [open PRs](https://github.com/pewdiepie-archdaemon/solaris/pulls) — this is not a duplicate.
- [ ] This PR targets `dev`
...
- [ ] **Style match**: the change uses Solaris's existing visual language. Specifically:
