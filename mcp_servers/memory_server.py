...
Imports MemoryManager and MemoryVectorStore from the Solaris codebase.
"""
...
_OWNER_ENV_KEYS = ("SOLARIS_MCP_MEMORY_OWNER", "SOLARIS_MEMORY_OWNER")
_OWNER_SCOPE_ERROR = (
    "Error: Memory MCP owner is not configured for an owner-scoped memory store. "
    "Set SOLARIS_MCP_MEMORY_OWNER for this server or use the owner-aware native memory tool."
)
