"""scripts/_lib/cli.py — shared scaffolding for the `solaris-*` CLIs.
...
parents-parser pattern. Usage:
    ...
    def build_parser():
        p = common_parser("solaris-foo", "Description.")
...
# Make repo root importable. Tools are invoked as `scripts/solaris-foo`
...
VERSION = "0.1.0"  # bumped centrally; every solaris-* CLI reports this
