...
const EMAIL_DOC_SPLIT_WIDTH_KEY = 'solaris-email-doc-split-width';
const EDGE_DOCK_WIDTH_KEY_PREFIX = 'solaris-edge-dock-width';
...
(function _initEdgeDockResizeHandles() {
  ...
  window.addEventListener('solaris:modal-opened', _positionEdgeDockResizeHandles);
  _positionEdgeDockResizeHandles();
})();
