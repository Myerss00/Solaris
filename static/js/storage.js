...
export const KEYS = {
  ...
  MODELS_EXPANDED: 'solaris-model-expanded',
  MODEL_ENDPOINTS: 'solaris-model-endpoints',
  MODEL_SELECTED: 'solaris-selected-model',
  SORT_ORDER: 'solaris-sessions-sort',
  CHAT_SEARCH_SCOPE: 'solaris-search-scope',
  INCOGNITO: 'solaris-incognito',
  RAG_ACTIVE: 'solaris-rag-active',
  MCP_ACTIVE: 'solaris-mcp-active',
  SECTION_ORDER: 'sidebar-section-order',
  ADMIN_LAST_TAB: 'admin-last-tab',
  DENSITY: 'solaris-density',
  WORKSPACE: 'solaris-workspace'
};
