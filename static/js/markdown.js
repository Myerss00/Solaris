...
function initMermaid() {
  if (!window.mermaid || window.__solarisMermaidReady) return;
  window.mermaid.initialize({ startOnLoad: false, theme: 'dark', securityLevel: 'loose' });
  window.__solarisMermaidReady = true;
}
window.solarisInitMermaid = initMermaid;
initMermaid();
...
const THINK_EXPANDED_KEY = 'solaris-thinking-expanded';
