...
const LS_KEY = 'solaris-theme';
const CUSTOM_THEMES_KEY = 'solaris-custom-themes';
...
const ADV_KEYS = [
  ...
  { key: 'brandColor',         css: '--brand-color',       label: 'Solaris Logo',    group: 'Sidebar' },
...
export function initThemeUI() {
  ...
  if (exportBtnEl) {
    ...
    newExp.addEventListener('click', () => {
      ...
      a.href = url;
      a.download = 'solaris_' + (obj.name || 'theme') + '.json';
      a.click();
