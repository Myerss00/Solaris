"""`solaris-research list --status complete` was returning nothing.
...
Part of #2122 (solaris-* CLI list/search bugs).
"""
...
def _load_cli():
    path = ROOT / "scripts" / "solaris-research"
    loader = importlib.machinery.SourceFileLoader("solaris_research_cli", str(path))
