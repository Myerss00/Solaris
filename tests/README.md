...
```text
[order-report] working directory: /path/to/solaris
...
[order-report] reproduce with: /path/to/solaris/venv/bin/python /path/to/solaris/tests/run_order_report.py --seed 284734921 -- tests/cli/ -q
```
