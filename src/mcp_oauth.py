...
Registration, authorization-code + PKCE, token refresh) to Solaris's web
...
# on Solaris. APP_PORT is intentionally not used: it is only the Docker host
