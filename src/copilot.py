...
COPILOT_USER_AGENT = os.environ.get(
    "SOLARIS_COPILOT_USER_AGENT", "Solaris/1.0"
)
COPILOT_INTEGRATION_ID = os.environ.get(
    "SOLARIS_COPILOT_INTEGRATION_ID", "vscode-chat"
)
COPILOT_EDITOR_VERSION = os.environ.get(
    "SOLARIS_COPILOT_EDITOR_VERSION", "Solaris/1.0"
)
